...
<body>
    ...
    <section id="bestsellers">
        <h2>Bestsellery</h2>
        <section id="widget">
            <input type='button' onclick='move("l1",-1)' value='<'>
            <section class="lista" id="l1">
                <?php
                $polaczenie=mysqli_connect('localhost', 'root', '', 'książki');
            
                $zapytanie="SELECT ksiazki.id, ksiazki.zdjecie, ksiazki.cena, ksiazki.tytul, ksiazki.autor, AVG(oceny_ksiazek.ocena) FROM ksiazki
                            ...
                            ORDER BY magazyn.ilosc_kupionych DESC
                            LIMIT 15;";
                ...
                while($wiersz=mysqli_fetch_array($wynik)){
                    echo "<section id=ksiazka>
                        <img src=$wiersz[1] onclick=window.location.href='ksiazka.php?id=$wiersz[0]'>
                        <section id=cenaocena>
                            <h5>$wiersz[2] zł</h5><p><i class='fas fa-star'></i>$wiersz[5]</p>
                        </section>
                        <p>$wiersz[3]</p>
                        <small>$wiersz[4]</small>
    ...
    <section id="topR">
        ...
        <section id="widget">
            <input type='button' onclick='move("l2",-1)' value='<'>
            <section class="lista" id="l2">
                <?php
                $polaczenie=mysqli_connect('localhost', 'root', '', 'książki');
